...
Use this index as the current entry point for project documentation.

| Document | Purpose |
|---|---|
| [Curriculum and simulator synchronization plan](curriculum-simulator-synchronization-plan.md) | Active delivery phases, architecture boundaries, and next work |
| [PPC decision policy](ppc-decision-policy.md) | Shared beginner evidence bands and action rules |

...
(function () {
  ...
  var TOOLS = [
    ...
    { id: 'campaign-architect', name: 'S8 Campaign Architect', tag: 'Planning', file: 'campaign-architect.html' },
    { id: 'account-audit', name: 'S9 Account Audit', tag: 'Audit', file: 'account-audit.html' },
    { id: 'client-onboarding', name: 'S11 Client Onboarding', tag: 'VA Workflow', file: 'client-onboarding.html' },
    { id: 'capstone-sequence', name: 'S12-S14 Capstone', tag: 'Capstone', file: 'capstone-sequence.html' },

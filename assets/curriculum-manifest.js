(function (root, factory) {
  ...
  var SIMULATORS = [
    ...
    { id: 'sqp-studio', title: 'S10 SQP Studio', file: 'sqp-studio.html', passingScore: 75 },
    { id: 'bid-decisions', title: 'S2 Bid Decisions', file: 'bid-decisions.html', passingScore: 75 },
    { id: 'campaign-architect', title: 'S8 Campaign Architect', file: 'campaign-architect.html', passingScore: 75 },
    { id: 'account-audit', title: 'S9 Account Audit', file: 'account-audit.html', passingScore: 75 },
    { id: 'client-onboarding', title: 'S11 Client Onboarding', file: 'client-onboarding.html', passingScore: 75 },
    { id: 'capstone-sequence', title: 'S12-S14 Capstone', file: 'capstone-sequence.html', passingScore: 85 },

# Beginner Deck Visual QA

Local review confirmed that the rewritten module viewer keeps the learning surface readable at standard desktop size. Module 00 slide 2 introduces **Amazon marketplace** with one plain-language definition, a familiar cutting-board example, and one visible next step. Module 02 slide 2 introduces **CPC** with a definition, a complete $30 ÷ 30 = $1 worked example, and a single calculation task.
